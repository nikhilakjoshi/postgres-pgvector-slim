...
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO citi_pg_app_owner;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public TO citi_pg_app_owner;

-- Ensure future objects inherit the privileges
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL PRIVILEGES ON TABLES TO citi_pg_app_owner;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL PRIVILEGES ON SEQUENCES TO citi_pg_app_owner;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL PRIVILEGES ON FUNCTIONS TO citi_pg_app_owner;
...
-- Set default role for users to use the application role
